...
import { EventResponse, PagedResponse } from '../../../core/models/api.model';
...
@Component({
  ...
  `,
    ...
    .search-input { padding: 0.75rem 1rem; border: 1.5px solid #dde1e7; border-radius: 8px; width: 100%; max-width: 400px; font-size: 0.95rem; outline: none; }
    .search-input:focus { border-color: #3498db; }
    .event-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem; }
    .event-card { background: #fff; border-radius: 12px; padding: 1.5rem; box-shadow: 0 2px 12px rgba(0,0,0,0.06); border-top: 4px solid #3498db; display: flex; flex-direction: column; gap: 0.75rem; }
    ...
    .privacy-badge--public { background: #e8f5e9; color: #27ae60; }
    .privacy-badge--private { background: #fce4ec; color: #e74c3c; }
    .privacy-badge--inviteonly { background: #fff3e0; color: #f39c12; }
    .event-card__title { font-size: 1.05rem; font-weight: 700; color: #2c3e50; }
    .event-card__desc { font-size: 0.875rem; color: #7f8c8d; line-height: 1.5; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
    .event-card__meta { display: flex; flex-direction: column; gap: 0.25rem; font-size: 0.8rem; color: #7f8c8d; }
    .event-card__footer { display: flex; justify-content: space-between; align-items: center; margin-top: auto; padding-top: 0.75rem; border-top: 1px solid #f0f0f0; }
    .organizer { font-size: 0.8rem; color: #95a5a6; }
