...
@Component({
          ...
          <div class="form-grid">
            ...
            <div class="form-group form-group--full">
              <label class="checkbox-label">
                <input formControlName="reminderEnabled" type="checkbox" />
                Enable Reminder
              </label>
            </div>
  ...
  `,
    ...
    .form-card { background: #fff; border-radius: 12px; padding: 2rem; box-shadow: 0 2px 12px rgba(0,0,0,0.06); }
    ...
    .form-actions { display: flex; justify-content: flex-end; gap: 1rem; margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid #f0f0f0; }
